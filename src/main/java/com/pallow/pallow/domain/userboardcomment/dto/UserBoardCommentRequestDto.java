...
public class UserBoardCommentRequestDto {
    ...
    public UserBoardComment toEntity(User createdBy, UserBoard userBoard) {
        return UserBoardComment.builder().content(content).user(createdBy).userBoard(userBoard).build();
    }
